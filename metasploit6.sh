...
sleep 1
echo -e "[${Green}+${clear}] 92i vas tout gerer..."
sleep 1
echo -e "[${Green}+${clear}] Removing ${Red}metasploit-framework${clear} directory ..."
cd $HOME
rm -rf metasploit-framework 2>log.txt
rm log.txt
echo -e "[${Green}+${clear}] C'est fait..."

echo
echo -e "[${Yellow}+${clear}] Veuillez patienté svp..."
sleep 3
echo "[+] mise a jour de termux..."
sleep 3
echo -e "[${Yellow}+${clear}] Ne tapez pas Entrer utilisez Y/n pour mettre a jour..."
sleep 3
clear
echo -e "
...
sleep 3
echo 
echo -e "[${Yellow}+${clear}] ${White} Please open new terminal and type/ouvrez une nouvelle session ${Cyan}msfconsole${clear}. Is it Working?/ca marche?${clear} [${Yellow}y/n${clear}]:"
read replyme
if [[ $replyme == 'y' ]]
then
echo -e "[${Yellow}+${clear}] Cheers! Metasploit V6 1.40 has been installed..."
echo -e "[${Yellow}+${clear}] F-society..."
sleep 2
echo -e "[${Yellow}+${clear}] See you again..."
echo -e "[${Yellow}+${clear}] Au revoire..."
